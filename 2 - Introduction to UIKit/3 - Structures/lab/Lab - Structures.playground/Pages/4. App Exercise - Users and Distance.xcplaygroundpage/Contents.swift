 ...
 */
let gerhard = User(name: "Gerhard", age: 50, height: 185, weight: 80, activityLevel: 5)
print(gerhard.name, gerhard.age,gerhard.height,gerhard.weight,gerhard.activityLevel)
