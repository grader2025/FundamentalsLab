...
struct RunningWorkout {
    ...
    var averageMilteTime: Double {
        return time / (distance / 1600)
    }
    }

var workoutToday = RunningWorkout(distance: 5230, time: 32, elevation: 150)
print(workoutToday.averageMilteTime)
...
var myStep = Steps(steps: 999, goal: 10000)
myStep.takeStep()
