...
struct User {
    ...
    var email: String
    var age: Int
    static var currentUser = User(userName: "Gerhard", email: "rader@mailbox.org", age: 50)
...
var me = User(userName: "Gerhard", email: "rader@mailbox.org", age: 50)
User.currentUser = me

var secondUser = User(userName: "Sonja", email: "Sonja@gmail.com", age: 45)
